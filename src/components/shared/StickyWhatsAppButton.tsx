...
export function StickyWhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 rounded-full bg-[#25D366] px-5 py-3.5 text-white shadow-lg transition-transform duration-300 hover:scale-105 active:scale-95 sm:bottom-6 sm:right-6"
