    ...
    <>
      ...
      <main>
        <PageHero
          ...
          primaryHref="/tours/rajasthan-tours"
        ...
        <QuickFacts facts={rajasthanQuickFacts} quoteButtonPageName="Rajasthan" />
            ...
            <Reveal>
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-ink-soft">
                <p>
                  ...
                  gets planned around, not the other way round. Few places in the world pack this
                  much visible history into such a compact area — Rajput dynasties spent
                  centuries building, expanding and defending fortress cities across this desert
                  landscape, and an unusually high proportion of what they built still stands,
                  still occupied in parts, and still genuinely worth walking through rather than
                ...
                <p>
                  ...
                  with your own guide and driver rather than a fixed coach tour. Jaipur, the
                  Pink City, opens most itineraries with Amber Fort and City Palace; Jodhpur,
                  the Blue City, follows with Mehrangarh looming over blue-washed rooftops;
                  Udaipur adds lakes and a noticeably softer, more romantic register; and
                  Jaisalmer, deep in the Thar Desert, closes many circuits with a fort that
                  people still actually live inside. Smaller stops — Pushkar&apos;s holy lake,
                  Ranthambore&apos;s tiger reserve, Chittorgarh&apos;s vast ruined capital —
                  slot naturally between the larger cities depending on how many days you have.
                </p>
                <p>
                  Beyond the forts and palaces, Rajasthan is also where many first-time visitors
                  get their most vivid introduction to Indian craft, colour and food — block-
                  printed textiles, miniature painting traditions still practised in small
                  workshops, and a cuisine shaped by desert conditions that favoured preserved,
                  spiced ingredients over fresh produce. Because the whole state runs on private
                  car and driver hire rather than fixed group schedules, an itinerary here can
                  move at whatever pace actually suits you — lingering an extra half-day at a
                  fort that catches your interest, or adding a lesser-known stop like Bundi or
                  Kumbhalgarh without disrupting the rest of the trip. It is, for good reason,
