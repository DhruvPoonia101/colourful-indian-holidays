...
const pagePath = "/destinations/udaipur";
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          primaryHref="/tours/udaipur-tour"
          primaryLabel="View Udaipur Tour"
          whatsappMessage="Hi! I'd like to plan an Udaipur trip with Colourful Indian Holidays."
        />

        <QuickFacts facts={udaipurQuickFacts} quoteButtonPageName="Udaipur" />
