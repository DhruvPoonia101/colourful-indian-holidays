...
const pagePath = "/destinations/jodhpur";
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          primaryHref="/tours/jodhpur-tour"
          primaryLabel="View Jodhpur Tour"
          whatsappMessage="Hi! I'd like to plan a Jodhpur trip with Colourful Indian Holidays."
        />

        <QuickFacts facts={jodhpurQuickFacts} quoteButtonPageName="Jodhpur" />
