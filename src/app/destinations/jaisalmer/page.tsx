...
const pagePath = "/destinations/jaisalmer";
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          primaryHref="/tours/jaisalmer-tour"
          primaryLabel="View Jaisalmer Tour"
          whatsappMessage="Hi! I'd like to plan a Jaisalmer trip with Colourful Indian Holidays."
        />

        <QuickFacts facts={jaisalmerQuickFacts} quoteButtonPageName="Jaisalmer" />
