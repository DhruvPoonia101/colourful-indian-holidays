...
export const rajasthanPopularTours: CityCard[] = [
  {
    ...
    tagline: "3–4 Days",
    description: "Amber Fort, City Palace and Hawa Mahal — a focused, unhurried look at Jaipur alone.",
  ...
  },
  {
    ...
    tagline: "8 Days",
    description: "Jaipur and Udaipur paired with two full days of tiger safaris at Ranthambore National Park.",
  ...
  },
  {
    ...
    tagline: "12 Days",
    description: "Jaipur, Jodhpur, Jaisalmer, Ranthambore, Udaipur and Pushkar — the full state, start to finish.",
