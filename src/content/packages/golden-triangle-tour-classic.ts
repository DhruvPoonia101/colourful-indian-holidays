...
export const goldenTriangleTours: PackageContent = {
  slug: "golden-triangle-tour-classic",
  ...
  faqs: [
    ...
    {
      question: "Is the Fatehpur Sikri stop worth the extra time?",
      answer:
        "Yes — it's one of the best-preserved abandoned cities anywhere in India, and adds only about an hour to the Agra–Jaipur drive, yet most short itineraries skip it entirely.",
    },
    {
      question: "Should we book an elephant ride up to Amber Fort?",
      answer:
        "A jeep ride is the more comfortable and consistently available option; elephant rides operate on a limited basis and welfare standards vary, so we're happy to talk through both honestly when planning your visit.",
    },
  ],
  relatedPackages: [
    {
    ...
    },
    {
      ...
      tagline: "8 Days",
      description: "Extend the classic route to Ajmer's Sufi shrine and Pushkar's sacred lake instead.",
