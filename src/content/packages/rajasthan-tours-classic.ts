...
export const rajasthanTours: PackageContent = {
  ...
  faqs: [
    ...
    {
      question: "Is the Ranakpur temple stop worth the detour?",
      answer:
        "Yes — its 1,400-plus individually carved marble pillars regularly surprise first-time visitors with their scale and craftsmanship, and it adds only a modest amount of time to the Jodhpur–Udaipur drive.",
    },
    {
      question: "Do we need to book heritage hotels well in advance?",
      answer:
        "It's a good idea, especially for October through March — genuinely characterful heritage properties in Jaipur and Udaipur have limited inventory and book out weeks or months ahead during peak season.",
    },
  ],
  relatedPackages: [
    {
