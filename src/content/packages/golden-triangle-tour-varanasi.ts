 ...
 *
 * NOTE FOR DHRUV: this covers the same four cities as /tours/north-india-tours
...
export const goldenTriangleVaranasiTours: PackageContent = {
  slug: "golden-triangle-tour-varanasi",
  ...
  itinerary: [
    ...
    },
    {
      ...
      imageAlt: "Evening Ganga Aarti ceremony on the Ganges, Varanasi",
    },
    {
      ...
      imageAlt: "The Dhamek Stupa at Sarnath, near Varanasi",
    },
    {
      ...
      imageAlt: "Traditional Banarasi silk weaving, Varanasi",
    },
    {
  ...
  faqs: [
    ...
    {
      question: "Is photography allowed at the cremation ghats?",
      answer:
        "It's a genuinely sensitive area — photography is generally discouraged out of respect for grieving families, and your guide will advise on where it's appropriate to take photos and where it's best to simply observe quietly instead.",
    },
  ],
  relatedPackages: [
    {
